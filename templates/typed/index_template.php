			...
			<!-- Features -->
				<div id="features-wrapper">
					<section id="features" class="container">
						<header>
							<h2>Gentlemen, behold! These are the <strong>Featured Products</strong>!</h2>
						</header>
						<div class="row">
							...
							<div class="4u 12u(mobile)">
								...
								<!-- Feature -->
									<section>
										<a href="#" class="image featured"><img src="<?php echo $template_url ?>/images/pic02.jpg" alt="" /></a>
										<header>
							...
							<div class="4u 12u(mobile)">
								...
								<!-- Feature -->
									<section>
										<a href="#" class="image featured"><img src="<?php echo $template_url ?>/images/pic03.jpg" alt="" /></a>
										<header>
								...
								<div id="content" class="8u 12u(mobile)">
									...
									<!-- Post -->
										<article class="box post">
											...
											<a href="#" class="image featured"><img src="<?php echo $template_url ?>/images/pic04.jpg" alt="" /></a>
									...
									<!-- Post -->
										<article class="box post">
											...
											<a href="#" class="image featured"><img src="<?php echo $template_url ?>/images/pic05.jpg" alt="" /></a>
												...
												<li>
													...
													<!-- Highlight -->
														<article class="box highlight">
															...
															<a href="#" class="image left"><img src="<?php echo $template_url ?>/images/pic06.jpg" alt="" /></a>
												...
												<li>
													...
													<!-- Highlight -->
														<article class="box highlight">
															...
															<a href="#" class="image left"><img src="<?php echo $template_url ?>/images/pic07.jpg" alt="" /></a>
															<p>Phasellus  sed laoreet massa id justo mattis pharetra. Fusce suscipit ligula vel quam
															viverra sit amet mollis tortor congue magna lorem ipsum dolor et quisque ut odio facilisis
															convallis. Etiam non nunc vel est suscipit convallis non id orci. Ut interdum tempus
															facilisis convallis. Etiam non nunc vel est suscipit convallis non id orci.</p>
